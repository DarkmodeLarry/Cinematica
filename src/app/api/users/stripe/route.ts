...
export async function POST(req: Request) {
  try {
    ...
    const stripePriceId = subscriptionPlans.find((plan) => plan.name === planName)?.stripePriceId
    ...
    const randomIcon = unusedIcons && unusedIcons[Math.floor(Math.random() * unusedIcons.length)]
