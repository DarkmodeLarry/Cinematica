...
export const siteConfig: SiteConfig = {
  name: 'Cinematica',
  description:
    'An open source Netflix inspired app built using the new app router, server components, trpc, and everything new in Next.js 13.',
