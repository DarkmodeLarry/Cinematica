...
interface DebouncedInputProps<TData extends object> extends Omit<InputProps, 'onChange'> {
    ...
    <div className={cn('relative', containerClassName)}>
      <Input
        ...
        className={cn(
          ...
          isOpen ? 'w-24 border dark:border-slate-500 xxs:w-28 xs:w-44' : 'w-0 border-none',
          className
        )}
        value={value}
