...
import type { ProfileWithIcon, SubscriptionPlan, UserSubscriptionPlan } from '@/types'
...
const AccountForm = ({
      ...
      <div className='flex flex-col gap-5'>
        ...
        <div className='flex flex-col gap-5'>
          <div className='space-y-6'>
            <Skeleton className='w-48 h-8 bg-neutral-600' />
            <Skeleton className='w-32 h-8 bg-neutral-600' />
          </div>
  ...
  if (userQuery.isError) {
    return <div className='text-lg text-red-500 sm:text-xl'>Error: {userQuery.error.message}</div>
  }
    ...
    <div className='flex flex-col gap-5'>
      <div className='space-y-2.5'>
        ...
        <div className='flex items-center gap-2.5'>
          <Icons.billing className='w-6 h-6 text-neutral-500' />
      ...
      {userQuery.data && (
        <div className='flex flex-col gap-5 text-neutral-100'>
          <div className='space-y-5'>
            <h2 className='text-lg text-neutral-400 sm:text-xl'>MEMBERSHIP & BILLING</h2>
          ...
          >
            Update account
            <Icons.chevronRight className='w-5 h-5 text-neutral-500' />
          </Link>
          <Separator className='bg-neutral-700' />
          {!subscriptionPlan?.stripeSubscriptionId ? (
            <div className='flex flex-col gap-2.5'>
              ...
              <p>
                Some errors must have occured during the subscription process, or you might have
                canceled your subscription.
              </p>
              <p>
                Either way, you can subscribe again by clicking{' '}
                <Link href='/login/plans' className='text-blue-400 cursor-pointer hover:underline'>
                  here
                </Link>
                .
              </p>
          ...
          <div className='space-y-5'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <span className='px-1 rounded-sm text-neutral-100 ring-2 ring-slate-100'>
    ...
    <>
      <AccordionItem value={profile.id} className='border-neutral-700'>
        ...
        <AccordionContent className='px-1'>
          <form
            className='grid w-full gap-5 mt-2'
            onSubmit={(...args) => void handleSubmit(onSubmit)(...args)}
          >
            <fieldset className='grid items-start w-full gap-2'>
