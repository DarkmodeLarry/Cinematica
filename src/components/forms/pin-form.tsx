...
const PinForm = () => {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center w-full min-h-screen gap-8'>
      <Button
        aria-label='Close menu'
        variant='ghost'
        size='sm'
        className='absolute right-0 rounded-none top-8'
        onClick={() => {
      ...
      <div className='flex flex-col items-center gap-2.5'>
        <div className='text-base font-medium text-center text-neutral-400 sm:text-lg'>
      ...
      <fieldset className='grid w-full gap-2 place-items-center'>
