...
const EditProfileForm = ({ profile }: EditProfileFormProps) => {
  ...
  return (
    <AnimatePresence>
      {iconPicker ? (
        <IconPicker icon={icon} setIconPicker={setIconPicker} setIcon={setIcon} />
      ) : (
        <motion.div
          className='container flex flex-col justify-center w-full max-w-3xl gap-5 pt-16 pb-5'
          ...
          >
            <div className='flex flex-col w-full gap-6 sm:flex-row'>
              <Button
                ...
                type='button'
                className='relative h-24 p-0 overflow-hidden rounded aspect-square w-fit hover:opacity-80 active:scale-90 sm:h-28 md:h-32'
              ...
              <div className='flex-1 w-full space-y-5'>
                ...
                <fieldset className='grid items-start w-full gap-2'>
                  <label htmlFor='language' className='text-base text-neutral-400 sm:text-lg'>
                    Language:
                  </label>
                  <SelectInput
                    control={control}
                ...
                <fieldset className='grid w-full items-start gap-3.5'>
                  <label htmlFor='gameHandle' className='flex flex-col gap-2'>
                    <span className='text-base text-neutral-400 sm:text-lg'>Game Handle:</span>
                    <span>
